...
This program requires Node.js to run if you want to connect to actual nodes during the demo, as well as launching the bridge.bat file before trying to connect to nodes on the program. 
